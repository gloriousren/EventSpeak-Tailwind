    ...
    <main class="pt-20">
      ...
      <section class="relative overflow-hidden pt-20 pb-32 px-8">
        <div class="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div class="relative">
            <div
              class="absolute -top-12 -left-12 w-64 h-64 bg-secondary-fixed/30 rounded-full blur-3xl"
            ></div>
            <div
      ...
      <section class="py-24 bg-surface-container-low">
        <div class="max-w-7xl mx-auto px-8">
          <div class="flex justify-between items-end mb-16">
            <div>
              <span
                class="text-tertiary font-headline font-bold uppercase tracking-[0.2em] text-sm"
                >Pilih Fokusmu</span
              >
              <h2
      ...
      <section class="py-24 bg-surface-container overflow-hidden">
        <div class="max-w-7xl mx-auto px-8 relative">
          <span
            class="material-symbols-outlined text-[12rem] absolute -top-12 -left-12 text-outline-variant/20 select-none"
            >format_quote</span
          >
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 relative z-10">
            ...
            >
              <div class="flex items-center gap-1 mb-6">
                <span class="material-symbols-outlined text-tertiary fill-1"
                  >star</span
                >
                <span class="material-symbols-outlined text-tertiary fill-1"
                  >star</span
